    ...
    <div class="card">
        <div class="row g-0 ruk-card-content">
            <div class="col-md-4 hotel-img">
                <img src="https://hailogics-ours.netlify.app/images/activities-card-img.png" class="img-fluid rounded-start" alt="Hotel Image" />
            </div>
            <div class="col-md-8">
                <div class="card-content-right">
                    ...
                    <div class="card-buttom d-flex justify-content-between">
                        <p class="card-text"><span class="Start-from">
                            Starting from <span class="text-dangerr">$240/night</span>
                        </span></p>
                        <button class="btn btn-book" fdprocessedid="31hp0i">Book Now</button>
                    </div>
                </div>
            </div>
        </div>
